...
public class DatabaseChangelog {
    ...
    public void insertAuthors(MongockTemplate template) {
        ...
        authors.add(Author.builder()
                ...
                .birthday(LocalDate.parse("1999-05-10"))
                .build());
        authors.add(Author.builder()
                .id("4")
                .name("Пупкин")
                .birthday(LocalDate.parse("1933-02-25"))
                .build());
    ...
    public void insertComments(MongockTemplate template) {
        ...
        Objects.requireNonNull(book).setComments(Set.of(
                ...
                new BookComment("Ну пожалуй теперь точно всё")
        ));
        template.save(book);
        ...
        Objects.requireNonNull(book).setComments(Set.of(
                new BookComment("Всё"),
                new BookComment("Ещё ведь тесты")
        ));
        template.save(book);
    }
}
